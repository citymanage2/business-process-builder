...
export const FULL_QUESTIONS: Question[] = [
...

  {
    id: "D35_workload",
    block: "D",
    text: "Сколько часов в неделю каждая роль задействована в этом процессе? (в % от рабочего времени)",
    type: "textarea",
    placeholder: "Например: Менеджер по продажам - 100% (полностью), Аккаунт-менеджер - 60%, Таргетолог - 40%...",
    required: false,
  },
