...
- [ ] Обновить шапку главной страницы: для авторизованных показывать "Личный кабинет", "Компании" вместо "Вход"
- [ ] Обновить главную кнопку: для авторизованных показывать "Создать компанию" вместо "Начать бесплатно"
- [ ] Добавить переходы: Личный кабинет → /profile, Компании → /companies, Создать компанию → /companies
- [ ] Протестировать оба состояния (авторизован/не авторизован)
