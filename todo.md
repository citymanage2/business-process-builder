...
- [ ] Реализовать сохранение позиций элементов после перетаскивания
- [ ] Добавить экспорт процесса в PDF с диаграммой и описанием
- [ ] Создать раздел с детальным описанием каждого этапа (что делать, где, в какой системе)
...
- [ ] Создать раздел "Документы" с перечнем необходимых регламентов и шаблонов
- [x] Обновить промпт генерации для создания детальных описаний и рекомендаций
- [ ] Создать UI панели для отображения метрик, воронок, документов
- [ ] Интегрировать drag & drop в ProcessView
