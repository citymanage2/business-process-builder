...
- [ ] Диагностировать почему после успешного входа главная страница не показывает авторизованное состояние
- [ ] Проверить сохранение cookie и session после входа
- [ ] Исправить код обработки входа для корректного сохранения сессии
- [ ] Протестировать вход локально
- [ ] Отправить на GitHub
