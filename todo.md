...
- [x] Сохранить checkpoint (1ff6154a)
- [x] Выгрузить в GitHub (commit 1ff6154)
- [ ] Задеплоить на Render и протестировать

## Объединение вопросов в блоке 4 сокращенной анкеты (17.12.2025)
- [ ] Найти компонент сокращенной анкеты
- [ ] Заменить два текстовых поля на таблицу с колонками "Роль" и "Зарплата"
- [ ] Протестировать ввод данных
- [ ] Выгрузить в GitHub и задеплоить

## Исправление пустого блока E в сокращённой анкете (17.12.2025)
- [x] Проанализировать почему блок E пустой в сокращённой анкете
- [x] Либо добавить ключевые вопросы в блок E, либо скрыть пустые блоки
