...
## Исправление фильтрации пустых блоков в сокращённой анкете (17.12.2025)
- [x] Проверить текущий код фильтрации
- [x] Исправить - использовать только блоки с вопросами (useMemo + filter)
- [x] Протестировать в браузере - показывает "Блок 1 из 5" вместо "Блок 1 из 7"
- [x] Написать unit-тесты (6 тестов прошли)
