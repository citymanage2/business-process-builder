...
- [x] Блоки всё ещё удаляются при drag and drop несмотря на исправления - нужно проверить серверную логику и БД - Добавлено детальное логирование для диагностики типов данных

## Отключение автосохранения drag and drop (28.01.2026)
- [x] Убрано автоматическое сохранение при drag and drop
- [x] Теперь блоки перемещаются локально, а сохранение происходит только по кнопке "Сохранить изменения"
- [x] Обновлено сообщение toast при перемещении элемента
